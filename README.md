...
本项目中有权授权的原创代码、文档及资源采用项目专用 **Dread Hunger Toolkit Noncommercial License 1.0**，完整条款见 [LICENSE](LICENSE)，以英文正文为准。这是允许查看源码的非商业许可证，不是 OSI 定义的开源许可证，也不是标准 PolyForm 许可证。

- 允许：个人学习、研究、修改，以及符合非商业条件的免费社区开服和免费分发。
- 禁止：售卖代码或成品、收费开服、VIP/付费道具/付费名额、利用本项目收费代搭建或提供运维服务、商业经营，以及通过本项目运营的服务进行广告、赞助或推广变现。修改、改名、打包成 EXE 或只提供在线服务，均不能绕过限制。
- “捐赠”“AA 分摊”“成本费”如果与入服、优先权或其他权益挂钩，同样不允许；无任何回报且真正自愿的非商业社区捐赠允许。自费租用基础设施运行非商业服务器本身不受禁止。
- 分发源码、修改版或编译文件时，须附完整许可证、保留版权及第三方声明，并标明修改。非营利或教育等机构不自动豁免商业使用限制。
